...
p3 <- ggplot() +
  theme_bw() +
  geom_line(data=UrbanoEstabilidad, aes(x=date, y=ScatTRed3000, colour="635 nm"), alpha=0.7, lwd=1) +
  geom_point(data=UrbanoEstabilidad, aes(x=date, y=ScatTRed3000, fill= "635 nm"), pch=21, colour="black", stroke=1, size=2) +
  ...
  geom_line(data=UrbanoEstabilidad, aes(x=date, y=ScatTGreen3000, colour="525 nm"), alpha=0.7, lwd=1) +
  geom_point(data=UrbanoEstabilidad, aes(x=date, y=ScatTGreen3000, fill= "525 nm"), pch=21, colour="black", stroke=1, size=2) +
  ...
  ggnewscale::new_scale_colour() +
  ggnewscale::new_scale_fill() +
  geom_line(data=UrbanoEstabilidad, aes(x=date, y=ScatTBlue3000, colour="450 nm"), alpha=0.7, lwd=1) +
  geom_point(data=UrbanoEstabilidad, aes(x=date, y=ScatTBlue3000, fill= "450 nm"), pch=21, colour="black", stroke=1, size=2) +
