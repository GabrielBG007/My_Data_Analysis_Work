...
p <- data2 %>% 
  ...
  annotate("text", x=6.85, y=116, label= "y= 4.7974x", colour="red", size=3) +
  annotate("text", x=6.85, y=105, label= expression("R"^2*"=0.9626 "), colour="red", size=3) +
  annotate("text", x=8.3, y=116, label= "y= 5.9419x", colour="green", size=3) +
  annotate("text", x=8.3, y=105, label= expression("R"^2*"=0.9754  "), colour="green", size=3) +
  annotate("text", x=9.75, y=116, label= "y= 7.3674x", colour="blue", size=3) +
  annotate("text", x=9.75, y=105, label= expression("R"^2*"=0.9794 "), colour="blue", size=3) +
