...
data2 <- data1[c(4:5,12,15:16),] %>% print()
...
p <- data2 %>% 
  ...
  annotate("text", x=7.75, y=100, label= "y= 3.084x", colour="red", size=3) +
  annotate("text", x=7.75, y=93, label= expression("R"^2*"=0.8275 "), colour="red", size=3) +
  annotate("text", x=8.25, y=100, label= "y= 5.271x", colour="green", size=3) +
  annotate("text", x=8.25, y=93, label= expression("R"^2*"=0.8013  "), colour="green", size=3) +
  annotate("text", x=8.75, y=100, label= "y= 7.042x", colour="blue", size=3) +
  annotate("text", x=8.75, y=93, label= expression("R"^2*"=0.7918 "), colour="blue", size=3) +
...
title <- ggdraw() + draw_label("Días con gran estabilidad atmosférica", fontface="bold")
