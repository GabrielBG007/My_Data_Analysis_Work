...
p1 <- data2 %>% 
  ...
  annotate("text", x=12.5, y=136, label= "y= 2.3929x", colour="red", size=3) +
  annotate("text", x=12.5, y=126, label= expression("R"^2*"=0.944 "), colour="red", size=3) +
  annotate("text", x=17.5, y=136, label= "y= 2.9313x", colour="green", size=3) +
  annotate("text", x=17.5, y=126, label= expression("R"^2*"=0.9091  "), colour="green", size=3) +
  annotate("text", x=22.5, y=136, label= "y= 3.6043x", colour="blue", size=3) +
  annotate("text", x=22.5, y=126, label= expression("R"^2*"=0.8802 "), colour="blue", size=3) +
...
q1 <- data2 %>% 
  ...
  scale_fill_manual("", breaks="450 nm", values= "blue", guide=guide_legend(order=1)) +
  annotate("text", x=12.5, y=136, label= "y= 2.1192x", colour="red", size=3) +
  annotate("text", x=12.5, y=126, label= expression("R"^2*"=0.9195 "), colour="red", size=3) +
  annotate("text", x=17.5, y=136, label= "y= 2.9241x", colour="green", size=3) +
  annotate("text", x=17.5, y=126, label= expression("R"^2*"=0.9104 "), colour="green", size=3) +
  annotate("text", x=22.5, y=136, label= "y= 3.4317x", colour="blue", size=3) +
  annotate("text", x=22.5, y=126, label= expression("R"^2*"=0.8561  "), colour="blue", size=3) +
...
plot_grid(t,x,ncol=2,rel_widths=c(1,1))

write.csv(data2, "C:\\Users\\gabri\\OneDrive\\Documentos\\Universidad\\Trabajo Fin De Grado\\Archivos Excel\\PM10_PM1_DíasConIntrusiónDePolvo.csv", row.names = FALSE )
