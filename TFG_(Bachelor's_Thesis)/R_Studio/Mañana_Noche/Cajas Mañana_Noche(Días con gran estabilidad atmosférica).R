...
title1 <- ggdraw() + draw_label("Días con gran estabilidad atmosférica (Mañana)", fontface="bold", size=8)

x5 <- plot_grid(title1, p1,ncol=1, rel_heights=c(0.1,1))
...
data3 <- data2[c(1438:1827,4144:4396,5476:5800),]
...
title2 <- ggdraw() + draw_label("Días  con gran estabilidad atmosférica (Mañana)", fontface="bold", size=8)
...
title3 <- ggdraw() + draw_label("Días con gran estabilidad atmosférica (Noche)", fontface="bold", size=8)

x6 <-plot_grid(title3, p3,ncol=1, rel_heights=c(0.1,1))


g3 <- plot_grid(x5,x6,ncol=2,nrow=1,rel_widths=c(1,1))



plot_grid(g1,g2,g3,ncol=1,nrow=3,rel_widths=c(1,1))
...
title4 <- ggdraw() + draw_label("Días con gran estabilidad atmosférica (Noche)", fontface="bold", size=8)

x4 <- plot_grid(title4, p4,ncol=1, rel_heights=c(0.1,1))


m3 <- plot_grid(x1,x2,x3,x4,ncol=2, nrow=2, rel_widths=c(1,1))

plot_grid(m1,m2,m3, ncol=3, nrow=1, rel_heights=c(1,1), rel_widths=c(1,1))
