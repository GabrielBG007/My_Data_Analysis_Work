...
p4 <- data2 %>% 
  ...
  annotate("text", x=5.25, y=86, label= "y= 2.7359x", colour="red", size=3) +
  annotate("text", x=5.25, y=78, label= expression("R"^2*"=0.8784 "), colour="red", size=3) +
  annotate("text", x=6.75, y=86, label= "y= 4.8047x", colour="green", size=3) +
  annotate("text", x=6.75, y=78, label= expression("R"^2*"=0.9124  "), colour="green", size=3) +
  annotate("text", x=8.25, y=86, label= "y= 6.4605x", colour="blue", size=3) +
  annotate("text", x=8.25, y=78, label= expression("R"^2*"=0.9168 "), colour="blue", size=3) +
