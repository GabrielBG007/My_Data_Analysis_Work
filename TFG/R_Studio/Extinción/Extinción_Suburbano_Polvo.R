...
p3 <- ggplot() +
  ...
  annotate("text", x= 12.5, y= 156, label= expression("y=0.9268*(PM"[10]*"- PM"[1]*") + 2.8297*(PM"[1]*")"), colour="red") +
  annotate("text", x= 12.5, y= 146, label=expression("R"^2*"=0.9973 "), colour="red") +
  annotate("text", x= 22.5, y= 156, label=expression("y=0.7996*(PM"[10]*"- PM"[1]*") + 4.2442*(PM"[1]*")") , colour="green") +
  annotate("text", x= 22.5, y= 146, label=expression("R"^2*"=0.9908 "), colour="green") +
  annotate("text", x= 32.5, y= 156, label= expression("y=0.6804*(PM"[10]*"- PM"[1]*") + 5.9227*(PM"[1]*")"), colour="blue") +
  annotate("text", x= 32.5, y= 146, label=expression("R"^2*"=0.9845 "), colour="blue") 
