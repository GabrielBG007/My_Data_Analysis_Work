...
SuburbanoPolvo1 <- SuburbanoPolvo %>% rename("635 nm"=ScatTRed3000 , "525 nm"=ScatTGreen3000 , "450 nm"=ScatTBlue3000)

SuburbanoPolvo2 <- SuburbanoPolvo1 %>% pivot_longer(
  c("635 nm","525 nm","450 nm"), names_to= "Scat3000", values_to="Scat3000V")


p2 <- ggplot() +
  theme_bw() +
  geom_boxplot(data=SuburbanoPolvo2, aes(x=Nombre1, y=Scat3000V, fill= Scat3000), alpha=0.7) +
